...
function Header($module) {
  this.$module = $module;
  this.$menuButton =
    $module && $module.querySelector(".nationalarchives-js-header-toggle");
  this.$menu =
    this.$menuButton &&
...
Header.prototype.syncState = function () {
  if (this.mql.matches) {
    this.$module.classList.remove("nationalarchives-header--menu-open");
    ...
    if (this.menuIsOpen) {
      this.$module.classList.add("nationalarchives-header--menu-open");
      this.$menu.removeAttribute("hidden");
    } else {
      this.$module.classList.remove("nationalarchives-header--menu-open");
