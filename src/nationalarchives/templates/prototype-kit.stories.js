...
import PlainWithSidebarTemplate from "./prototype-kit/plain-with-sidebar.njk?raw";
...
export const PlainWithSidebar = (params) =>
  nunjucks.renderString(PlainWithSidebarTemplate, { ...params });
